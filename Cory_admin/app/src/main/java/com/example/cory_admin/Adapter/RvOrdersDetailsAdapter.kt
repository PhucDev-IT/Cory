...
import com.example.cory_admin.Model.CartModel
import com.example.cory_admin.Model.FormatCurrency
import com.example.cory_admin.R

class RvOrdersDetailsAdapter(private val list: List<CartModel>) :
    RecyclerView.Adapter<RvOrdersDetailsAdapter.viewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.viewholder_order_details, parent, false)
